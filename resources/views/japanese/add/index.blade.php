...
<div class="modelCreateFrom" id="Paragraph">
    ...
    @csrf
        ...
        <div class="form-input-category mt-10">
            ...
            <input type="file" class="input-name" name="image">
        </div>
        <div class="form-btn">
            <button>{{ __('messages.Add') }}</button>
        </div>
        <div class="BtnCloseCategoryTask" onclick="closeFormParagraphPopup()">
            <p>X</p>
        </div>
    </form>
</div>
...
<script>
    ...
    function CreateParagraphForm(){
        ...
        if (modelCreateParagraph.style.display === 'none' || modelCreateParagraph.style.display === '') {
            modelCreateParagraph.style.display = 'block'; 
        } else {
            modelCreateParagraph.style.display = 'none';
        }
    }

    function closeFormParagraphPopup() {
        const modelCreateParagraph = document.getElementById('Paragraph')
        if (modelCreateParagraph.style.display === 'none' || modelCreateParagraph.style.display === '') {
            modelCreateParagraph.style.display = 'block'; 
        } else {
