    ...
    <div class="overview-two">
        <div class="chart1">
            <div class="legend-container">
                <div class="legend-item"><span class="legend-color" style="background-color: #008FFB;"></span>Team A</div>
                <div class="legend-item"><span class="legend-color" style="background-color: #00E396;"></span>Team B</div>
                <div class="legend-item"><span class="legend-color" style="background-color: #FEB019;"></span>Team C</div>
                <div class="legend-item"><span class="legend-color" style="background-color: #FF4560;"></span>Team D</div>
            </div>
            <div id="chart1"></div>
        </div>
        <div class="chart2">
