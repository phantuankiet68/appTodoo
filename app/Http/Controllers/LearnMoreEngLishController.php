...
class LearnMoreEngLishController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        try {
            $learnQuery = LearnMore::with(['user','language'])
    ...
    {
        return view('learnMoreEnglish.create'); // Hiển thị form tạo từ vựng mới
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('learn_more_english.index')->with('success', 'Vocabulary created successfully.'); // Chuyển hướng về danh sách
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('learn_more_english.index')->with('success', 'Vocabulary updated successfully.');
    }
    ...
    public function destroy($id)
    {
        $learnMore = LearnMore::findOrFail($id);
        $learnMore->delete();
        return redirect()->route('learn_more_english.index')->with('success', 'Deleted successfully');
    }
}
